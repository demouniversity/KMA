...
namespace CognitiveSearch.UI
{
    public class DocumentSearchClient
    {
        ...
        private string BlobStorageEndpoint { get; set; }
        ...
        //MODIFIED: Endpoint
        private static string defaultContainerUriValue = "https://{storage-account-name}.{BlobStorageEndpoint}/{container-name}";
        ...
        public DocumentSearchClient(IConfiguration configuration)
        {
            try
            {
                ...
                //MODIFIED: Endpoint
                _searchIndexClient = new SearchIndexClient(new Uri($"https://{searchServiceName}.{SearchEndpoint}/"), new AzureKeyCredential(apiKey), options: clientOptions);
        ...
        {
            //MODIFIED: 
            SearchIndexerClient _searchIndexerClient = new SearchIndexerClient(new Uri($"https://{searchServiceName}.{SearchEndpoint}/"), new AzureKeyCredential(apiKey));
